    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-DELETEapi-invoices--id-">Remove the specified resource from storage.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;links&quot;: [
        ...
        {
            &quot;url&quot;: &quot;http://localhost/api/invoices?page=1&quot;,
            &quot;label&quot;: &quot;1&quot;,
            &quot;active&quot;: true
        },
        {
...
<div class="bash-example">
    ...
    \"customer_contact\": \"mniihfqcoynlazghdtqtq\",
    \"due\": 11613.31890586,
    \"paid\": 11613.31890586,
    \"date\": \"2025-06-08T22:10:30\"
}"
</code></pre></div>
...
<small>number</small>&nbsp;
 &nbsp;
               ...
               step="any"               name="amount"                data-endpoint="POSTapi-invoices"
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="customer_contact"                data-endpoint="POSTapi-invoices"
...
<p>Must not be greater than 255 characters. Example: <code>mniihfqcoynlazghdtqtq</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>due</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="due"                data-endpoint="POSTapi-invoices"
               value="11613.31890586"
               data-component="body">
    <br>
<p>Example: <code>11613.31890586</code></p>
...
<small>number</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="paid"                data-endpoint="POSTapi-invoices"
               value="11613.31890586"
               data-component="body">
    <br>
<p>Example: <code>11613.31890586</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="date"                data-endpoint="POSTapi-invoices"
               value="2025-06-08T22:10:30"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-06-08T22:10:30</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/invoices/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;No query results for model [App\\Models\\Invoice] 17&quot;
}</code>
 </pre>
    </span>
...
<small>number</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="amount"                data-endpoint="PUTapi-invoices--id-"
               value="11613.31890586"
               data-component="body">
    <br>
<p>Example: <code>11613.31890586</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="customer_name"                data-endpoint="PUTapi-invoices--id-"
               value="mqeopfuudtdsufvyvddqa"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>mqeopfuudtdsufvyvddqa</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="customer_contact"                data-endpoint="PUTapi-invoices--id-"
               value="mniihfqcoynlazghdtqtq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>mniihfqcoynlazghdtqtq</code></p>
...
<small>number</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="due"                data-endpoint="PUTapi-invoices--id-"
               value="11613.31890586"
               data-component="body">
    <br>
<p>Example: <code>11613.31890586</code></p>
...
<small>number</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="paid"                data-endpoint="PUTapi-invoices--id-"
               value="11613.31890586"
               data-component="body">
    <br>
<p>Example: <code>11613.31890586</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="date"                data-endpoint="PUTapi-invoices--id-"
               value="2025-06-08T22:10:30"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-06-08T22:10:30</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-invoices--id-">Remove the specified resource from storage.</h2>
